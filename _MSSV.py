...
def select_move(cur_state, remain_time):
    ...
    if(len(valid_moves) > 0):
        ...
        #         # print(board, currentBoard, depth, alpha, beta, isMaximize)
        #         score = miniMax(board, currentBoard, depth, alpha, beta, isMaximize)
